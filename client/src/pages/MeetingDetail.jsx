                          ...
                          return (
                            <div key={t._id} className="flex items-center justify-between p-2 bg-surface rounded-lg">
                              <div className="flex items-center gap-2 min-w-0">
                                ...
                                {t.autoGenerated && <span className="tag bg-info/10 text-primary-700 shrink-0">自动</span>}
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="flex items-center gap-2 mt-1 flex-wrap">
                            ...
                            {t.autoGenerated && <span className="tag bg-info/10 text-primary-700">自动</span>}
                            {t.taskSource === 'dashboard' && <span className="tag bg-primary/10 text-primary-700">Dashboard</span>}
                            {t.isCTC && <span className="tag bg-danger/10 text-danger">CTC</span>}
