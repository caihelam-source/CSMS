...
import {
  SOURCE_COLOR, SOURCE_LABEL, isToday, applyOnlyOpen, groupByDay, WEEKDAYS,
              ...
              <div className="space-y-1.5">
                {dayEvents.map((e) => (
                  <button
                    ...
                    style={{ backgroundColor: e.overdue ? '#fee2e2' : `${SOURCE_COLOR[e.source] || '#94a3b8'}0d` }}
                  >
                    <span className="w-2.5 h-2.5 rounded-full shrink-0" style={{ backgroundColor: SOURCE_COLOR[e.source] || '#94a3b8' }} />
