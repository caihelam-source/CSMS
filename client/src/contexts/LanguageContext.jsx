...
const TRANSLATIONS = {
  zh: {
    ...
    settingsPassword: '账户密码',
    settingsAppearance: '外观主题',
    settingsNotifications: '通知偏好',
    settingsSubtitle: '管理你的账户信息与系统偏好',
    profileName: '姓名',
    profileEmail: '邮箱',
    saveChanges: '保存修改',
    saving: '保存中…',
    ...
    updatePwd: '更新密码',
    updating: '更新中…',
    pwdHint: '密码至少 6 位，且与确认密码一致',
    appearanceDesc: '选择浅色、深色，或跟随系统设置。',
    themeLight: '浅色',
    themeDark: '深色',
    themeSystem: '跟随系统',
    notifEmailTitle: '邮件通知',
    notifEmailDesc: '合规提醒触发时通过邮件提醒我',
    notifTaskTitle: '任务提醒',
    notifTaskDesc: '任务临近截止日期时通知我',
    notifNote: '偏好保存在本设备，刷新后依然生效。',
  },
  en: {
    // Navbar
    dashboard: 'Dashboard',
    ...
    updating: 'Updating…',
    pwdHint: 'At least 6 characters and must match confirmation.',
    appearanceDesc: 'Choose light, dark, or follow system.',
    themeLight: 'Light',
    themeDark: 'Dark',
    themeSystem: 'System',
    notifEmailTitle: 'Email Notifications',
    notifEmailDesc: 'Email me when compliance reminders are triggered',
    notifTaskTitle: 'Task Reminders',
    notifTaskDesc: 'Notify me as task deadlines approach',
    notifNote: 'Preferences are saved on this device and persist after refresh.',
  },
}
